<template>
  <div class="flex flex-wrap">
    <div
      class="w-full lg:w-8/12 bg-gray-50 dark:bg-gray-800 text-black dark:text-white py-6 px-6 rounded-3xl"
    >
      ...
      <div class="flex flex-wrap justify-between items-center pb-8">
        ...
        <div class="flex items-center mt-4 md:mt-0">
          <button class="bg-transparent" title="List View">
            <svg
          ...
          <button
            class="bg-gray-50 dark:bg-gray-700 p-2 ml-2"
            title="Grid View"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="w-full mt-8 lg:mt-0 lg:w-4/12 lg:pl-4">
      <div
        class="bg-gray-50 dark:bg-gray-800 text-black dark:text-white rounded-3xl px-6 pt-6"
      >
        <div class="flex text-2xl pb-6 font-bold">
          <p>Client Messages</p>
        </div>
        <div>
          <div
            class="border-t solid border-gray-700 p-4 flex 2xl:items-start w-full hover:bg-gray-100 dark:hover:bg-gray-700"
          >
            <img
              src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2550&q=80"
              alt="profile image"
